...
public class CopperDroidDiesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(entity.getPersistentData().getDouble("HomeX"), entity.getPersistentData().getDouble("HomeY"), entity.getPersistentData().getDouble("HomeZ")))).getBlock() == DuelsdreadModBlocks.COPPER_STATION_EMPTY
				.get()) {
				...
				_level.sendParticles(ParticleTypes.CLOUD, (entity.getPersistentData().getDouble("HomeX") + 0.5), (entity.getPersistentData().getDouble("HomeY") + 0.5), (entity.getPersistentData().getDouble("HomeZ") + 0.5), 25, 0.1, 0.2, 0.1, 0.07);
			{
				...
				BlockState _bs = DuelsdreadModBlocks.COPPER_STATION.get().defaultBlockState();
			...
			if (world instanceof ServerLevel _level) {
				ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(DuelsdreadModBlocks.COPPER_STATION.get()));
