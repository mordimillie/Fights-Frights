...
public class CopperDroidSpawnProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()))).getBlock() == DuelsdreadModBlocks.COPPER_STATION_EMPTY.get()) {
			...
			if (entity instanceof CopperDroidEntity) {
				((CopperDroidEntity) entity).setAnimation("On");
			}
		}
	}
}
