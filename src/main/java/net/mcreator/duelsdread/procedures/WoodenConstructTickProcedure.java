...
public class WoodenConstructTickProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		double dx = 0;
		double dz = 0;
		if ((world.getBlockState(BlockPos.containing(entity.getPersistentData().getDouble("HomeX"), entity.getPersistentData().getDouble("HomeY"), entity.getPersistentData().getDouble("HomeZ")))).getBlock() == DuelsdreadModBlocks.WOODEN_STATION_EMPTY
				.get()) {
