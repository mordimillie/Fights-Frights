...
public class WoodenConstructSpawnProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()))).getBlock() == DuelsdreadModBlocks.WOODEN_STATION_EMPTY.get()) {
			...
			if (entity instanceof WoodenConstructEntity) {
				((WoodenConstructEntity) entity).setAnimation("On");
			}
		}
	}
}
