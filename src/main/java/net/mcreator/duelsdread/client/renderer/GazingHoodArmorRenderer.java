...
import net.mcreator.duelsdread.item.model.GazingHoodModel;
import net.mcreator.duelsdread.item.GazingHoodItem;

public class GazingHoodArmorRenderer extends GeoArmorRenderer<GazingHoodItem> {
	public GazingHoodArmorRenderer() {
		super(new GazingHoodModel());
	...
	@Override
	public RenderType getRenderType(GazingHoodItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
