...
public class DryfieldTrunkDecorator extends TrunkVineDecorator {
	public static Codec<DryfieldTrunkDecorator> CODEC = Codec.unit(DryfieldTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("dryfield_tree_trunk_decorator", DECORATOR_TYPE));
	}
