...
package net.mcreator.duelsdread.world.features.treedecorators;
...
public class DryfieldLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(DryfieldLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("dryfield_tree_leave_decorator", DECORATOR_TYPE));
	}

	public DryfieldLeaveDecorator() {
		super(0.25f);
	}
