...
public class DryfieldFruitDecorator extends CocoaDecorator {
	public static Codec<DryfieldFruitDecorator> CODEC = Codec.unit(DryfieldFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("dryfield_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public DryfieldFruitDecorator() {
		super(0.2f);
	}
