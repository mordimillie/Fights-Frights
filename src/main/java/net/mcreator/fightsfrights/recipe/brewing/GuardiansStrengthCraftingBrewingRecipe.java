...
public class GuardiansStrengthCraftingBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new GuardiansStrengthCraftingBrewingRecipe());
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionContents.createItemStack(input.getItem(), FightsfrightsModPotions.GUARDIANS_STRENGTH);
		}
