...
public class TrashcanGUIScreen extends AbstractContainerScreen<TrashcanGUIMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("fightsfrights:textures/screens/trashcan_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("fightsfrights:textures/screens/trashgui.png"), this.leftPos + 0, this.topPos + -1, 0, 0, 176, 166, 176, 166);
	...
	public void init() {
		...
		button_trash = Button.builder(Component.translatable("gui.fightsfrights.trashcan_gui.button_trash"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new TrashcanGUIButtonMessage(0, x, y, z));
