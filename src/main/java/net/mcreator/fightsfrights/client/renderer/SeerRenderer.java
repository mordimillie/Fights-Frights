...
public class SeerRenderer extends GeoEntityRenderer<SeerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SeerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
