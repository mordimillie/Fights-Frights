...
public class EffigyRenderer extends GeoEntityRenderer<EffigyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, EffigyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
