...
public class MimicScowlRenderer extends GeoEntityRenderer<MimicScowlEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MimicScowlEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
