...
public class PioneerRenderer extends GeoEntityRenderer<PioneerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PioneerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
