...
public class WickeWarmongerRenderer extends GeoEntityRenderer<WickeWarmongerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, WickeWarmongerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
