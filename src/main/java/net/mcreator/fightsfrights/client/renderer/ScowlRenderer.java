...
public class ScowlRenderer extends GeoEntityRenderer<ScowlEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ScowlEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
