...
public class MimicBeetlesRenderer extends GeoEntityRenderer<MimicBeetlesEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MimicBeetlesEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
