...
public class ImperialIllagerP1Renderer extends GeoEntityRenderer<ImperialIllagerP1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ImperialIllagerP1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
