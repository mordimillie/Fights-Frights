...
public class MaliciousMonarchP1Renderer extends GeoEntityRenderer<MaliciousMonarchP1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MaliciousMonarchP1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
