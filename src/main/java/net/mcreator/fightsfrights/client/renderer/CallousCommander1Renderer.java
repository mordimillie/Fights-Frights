...
public class CallousCommander1Renderer extends GeoEntityRenderer<CallousCommander1Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, CallousCommander1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
