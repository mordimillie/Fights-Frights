...
public class ImperialIllagerP2Renderer extends GeoEntityRenderer<ImperialIllagerP2Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ImperialIllagerP2Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
