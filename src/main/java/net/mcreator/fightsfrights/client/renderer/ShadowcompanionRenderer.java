...
public class ShadowcompanionRenderer extends GeoEntityRenderer<ShadowcompanionEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ShadowcompanionEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
