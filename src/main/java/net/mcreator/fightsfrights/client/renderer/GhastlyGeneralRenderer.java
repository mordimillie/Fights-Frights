...
public class GhastlyGeneralRenderer extends GeoEntityRenderer<GhastlyGeneralEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, GhastlyGeneralEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
