...
public class MMtickP2Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null) && entity.isAlive() && (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).isAlive()) {
			if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
				_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_SummonCooldown, (int) ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_SummonCooldown) : 0) + 1));
			if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
				_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_ShootCooldown, (int) ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_ShootCooldown) : 0) + 1));
			if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
				_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_TeleportCooldown, (int) ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_TeleportCooldown) : 0) + 1));
			if ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_TeleportCooldown) : 0) >= 320) {
				if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
					_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_ShootCooldown, 0);
				if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
					_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_TeleportCooldown, 0);
				if (entity instanceof MaliciousMonarchP2Entity) {
					((MaliciousMonarchP2Entity) entity).setAnimation("teleport");
				}
				TpRadius = 20;
				...
				if ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_SummonCooldown) : 0) >= 110
					...
					if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
						_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_ShootCooldown, 0);
					if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
						_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_SummonCooldown, 0);
					if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
						_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_Minion, 0);
					{
						...
						for (Entity entityiterator : _entfound) {
							if (entityiterator instanceof Pillager || entityiterator instanceof Vindicator || entityiterator instanceof Evoker || entityiterator instanceof Ravager) {
								if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
									_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_Minion, (int) ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_Minion) : 0) + 1));
							}
						}
					}
					if (!((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_Minion) : 0) >= 17)) {
					...
					if ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_ShootCooldown) : 0) >= 95) {
						if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
							_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_ShootCooldown, 0);
						if (entity instanceof MaliciousMonarchP2Entity) {
							((MaliciousMonarchP2Entity) entity).setAnimation("attack");
						}
							...
							if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null) && entity.isAlive() && (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).isAlive()) {
										...
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY() + 0.2), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								{
									...
									if (!projectileLevel.isClientSide()) {
										...
										}.getArrow(projectileLevel, entity, 15, 1, (byte) 0);
										_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
										_entityToSpawn.shoot(_shootFrom.getLookAngle().x, _shootFrom.getLookAngle().y, _shootFrom.getLookAngle().z, (float) 2.5, (float) 0.2);
						...
						if (entity instanceof MaliciousMonarchP2Entity _datEntSetI)
							_datEntSetI.getEntityData().set(MaliciousMonarchP2Entity.DATA_TeleportCooldown,
									(int) ((entity instanceof MaliciousMonarchP2Entity _datEntI ? _datEntI.getEntityData().get(MaliciousMonarchP2Entity.DATA_TeleportCooldown) : 0) - 30));
					}
				}
			}
		}
