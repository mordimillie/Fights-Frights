...
public class BanshaaOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity.isAlive() && !((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
			if ((entity instanceof BanshaaEntity _datEntL3 && _datEntL3.getEntityData().get(BanshaaEntity.DATA_HasScreamed)) == false
