...
public class SingleUsePushProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity, ItemStack itemstack) {
		...
		entity.push((2 * (((x + 0.5) - entity.getX()) / Math.sqrt(Math.pow((x + 0.5) - entity.getX(), 2) + Math.pow((y + 2) - entity.getY(), 2) + Math.pow((z + 0.5) - entity.getZ(), 2)))),
				(2 * (((y + 2) - entity.getY()) / Math.sqrt(Math.pow((x + 0.5) - entity.getX(), 2) + Math.pow((y + 2) - entity.getY(), 2) + Math.pow((z + 0.5) - entity.getZ(), 2)))),
				(2 * (((z + 0.5) - entity.getZ()) / Math.sqrt(Math.pow((x + 0.5) - entity.getX(), 2) + Math.pow((y + 2) - entity.getY(), 2) + Math.pow((z + 0.5) - entity.getZ(), 2)))));
		itemstack.shrink(1);
