...
public class TickP2ImperialIllagerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double randomZ = 0;
		double scanY = 0;
		if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null) && entity.isAlive()) {
			if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
				_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_SummonCooldown, (int) ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_SummonCooldown) : 0) + 1));
			if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
				_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_ShootCooldown, (int) ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_ShootCooldown) : 0) + 1));
			if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
				_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_TeleportCooldown, (int) ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_TeleportCooldown) : 0) + 1));
			if ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_TeleportCooldown) : 0) >= 600) {
				if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
					_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_ShootCooldown, 0);
				if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
					_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_TeleportCooldown, 0);
				if (entity instanceof ImperialIllagerP2Entity) {
					((ImperialIllagerP2Entity) entity).setAnimation("teleport");
				}
				TpRadius = 20;
				...
				if ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_SummonCooldown) : 0) >= 165
					...
					if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
						_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_ShootCooldown, 0);
					if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
						_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_SummonCooldown, 0);
					if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
						_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_Minion, 0);
					{
						...
						for (Entity entityiterator : _entfound) {
							if (entityiterator instanceof Pillager || entityiterator instanceof Vindicator || entityiterator instanceof Vex || entityiterator instanceof Ravager) {
								if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
									_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_Minion, (int) ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_Minion) : 0) + 1));
							}
						}
					}
					if (!((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_Minion) : 0) >= 17)) {
						if (entity instanceof ImperialIllagerP1Entity) {
							((ImperialIllagerP1Entity) entity).setAnimation("Summon");
						}
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:ominous_summoning")), SoundSource.HOSTILE, 1, 2);
							} else {
								_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:ominous_summoning")), SoundSource.HOSTILE, 1, 2, false);
							}
						}
						FightsfrightsMod.queueServerWork(20, () -> {
							...
							if (world instanceof ServerLevel _level)
								_level.sendParticles((SimpleParticleType) (FightsfrightsModParticleTypes.OMINOUS_SOUL.get()), (entity.getX() + 5), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) x, (int) z) + 1), (entity.getZ()),
										10, 0.1, 0.1, 0.1, 0.05);
							if (world instanceof ServerLevel _level)
							...
							if (world instanceof ServerLevel _level)
								_level.sendParticles((SimpleParticleType) (FightsfrightsModParticleTypes.OMINOUS_SOUL.get()), (entity.getX()), (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) x, (int) z) + 1), (entity.getZ() + 5),
										10, 0.1, 0.1, 0.1, 0.05);
							if (world instanceof ServerLevel _level)
					...
					if ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_ShootCooldown) : 0) >= 140) {
						if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
							_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_ShootCooldown, 0);
						if (entity instanceof ImperialIllagerP2Entity) {
							((ImperialIllagerP2Entity) entity).setAnimation("attack");
						}
						FightsfrightsMod.queueServerWork(10, () -> {
							if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null) && entity.isAlive()) {
								...
								entity.lookAt(EntityAnchorArgument.Anchor.EYES, new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()),
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY() + 0.2), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								{
									...
									if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null) && entity.isAlive()) {
												...
												((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY() + 0.2), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
										{
											...
											if (!projectileLevel.isClientSide()) {
												...
												_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
												_entityToSpawn.shoot(_shootFrom.getLookAngle().x, _shootFrom.getLookAngle().y, _shootFrom.getLookAngle().z, (float) 1.5, (float) 0.2);
												projectileLevel.addFreshEntity(_entityToSpawn);
											}
										}
										FightsfrightsMod.queueServerWork(10, () -> {
						...
						if (entity instanceof ImperialIllagerP2Entity _datEntSetI)
							_datEntSetI.getEntityData().set(ImperialIllagerP2Entity.DATA_TeleportCooldown,
									(int) ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_TeleportCooldown) : 0) - 30));
					}
				}
			}
		}
