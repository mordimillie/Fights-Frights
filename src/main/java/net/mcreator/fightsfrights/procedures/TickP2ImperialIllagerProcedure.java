			...
			if ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_TeleportCooldown) : 0) >= 600) {
				...
				if ((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_SummonCooldown) : 0) >= 165
					...
					if (!((entity instanceof ImperialIllagerP2Entity _datEntI ? _datEntI.getEntityData().get(ImperialIllagerP2Entity.DATA_Minion) : 0) >= 17)) {
						...
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:ominous_summoning")), SoundSource.HOSTILE, 1, 2);
							} else {
								_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:ominous_summoning")), SoundSource.HOSTILE, 1, 2, false);
							}
						}
