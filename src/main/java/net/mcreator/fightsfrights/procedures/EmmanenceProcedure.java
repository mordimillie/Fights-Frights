...
public class EmmanenceProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(FightsfrightsModMobEffects.INFECTED.get()) && Mth.nextInt(RandomSource.create(), 1, 30) == 1
				|| entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(FightsfrightsModMobEffects.ASYMPTOMATIC.get()) && Mth.nextInt(RandomSource.create(), 1, 30) == 1) {
