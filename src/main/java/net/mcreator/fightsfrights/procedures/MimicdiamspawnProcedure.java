...
public class MimicdiamspawnProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity) {
		...
		if (world.getLevelData().getGameRules().getBoolean(FightsfrightsModGameRules.DO_MIMIC_BEETLES) == true
				&& !(EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SILK_TOUCH, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) != 0) && (blockstate.getBlock() == Blocks.DEEPSLATE_DIAMOND_ORE
						|| blockstate.getBlock() == Blocks.DEEPSLATE_REDSTONE_ORE || blockstate.getBlock() == Blocks.IRON_ORE || blockstate.getBlock() == Blocks.DEEPSLATE_GOLD_ORE || blockstate.getBlock() == Blocks.NETHER_GOLD_ORE)) {
