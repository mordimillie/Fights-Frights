...
public class MimicBanshaatickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
			if ((entity instanceof MimicBanshaaEntity _datEntL2 && _datEntL2.getEntityData().get(MimicBanshaaEntity.DATA_HasScreamed)) == false
				...
				if (entity instanceof MimicBanshaaEntity _datEntSetL)
					_datEntSetL.getEntityData().set(MimicBanshaaEntity.DATA_HasScreamed, true);
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 120, 255, false, false));
				if (entity instanceof MimicBanshaaEntity) {
					((MimicBanshaaEntity) entity).setAnimation("Banshaa.Scream");
				}
				FightsfrightsMod.queueServerWork(20, () -> {
					...
					if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
						if ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(FightsfrightsModMobEffects.GAZED.get(), 480, 1, false, true));
					}
					FightsfrightsMod.queueServerWork(4, () -> {
						...
						FightsfrightsMod.queueServerWork(480, () -> {
							if (entity instanceof MimicBanshaaEntity _datEntSetL)
								_datEntSetL.getEntityData().set(MimicBanshaaEntity.DATA_HasScreamed, false);
						});
					});
				});
			}
