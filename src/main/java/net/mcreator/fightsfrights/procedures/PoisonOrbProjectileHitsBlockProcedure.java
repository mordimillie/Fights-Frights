	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(x, y + 1, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:ominousgem")), SoundSource.BLOCKS, 1, 2);
			} else {
				_level.playLocalSound(x, (y + 1), z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:ominousgem")), SoundSource.BLOCKS, 1, 2, false);
			}
		}
