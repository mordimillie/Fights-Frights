...
public class MaliciousMonarchP2Entity extends Monster implements GeoEntity {
	...
	public MaliciousMonarchP2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.MALICIOUS_MONARCH_P_2.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "imperial_illager_phantomp2");
