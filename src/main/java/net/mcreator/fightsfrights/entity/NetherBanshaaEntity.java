...
public class NetherBanshaaEntity extends Monster implements GeoEntity {
	...
	public NetherBanshaaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.NETHER_BANSHAA.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(FightsfrightsModEntities.NETHER_BANSHAA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
