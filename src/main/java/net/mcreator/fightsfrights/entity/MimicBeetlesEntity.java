...
public class MimicBeetlesEntity extends Monster implements GeoEntity {
	...
	public MimicBeetlesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.MIMIC_BEETLES.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mimicdiamond");
		this.entityData.define(DATA_ore, true);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:mb_idle"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:mb_step")), 0.15f, 1);
	}
