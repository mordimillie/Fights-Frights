...
public class NetherSpiderEntity extends Spider {
	public NetherSpiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.NETHER_SPIDER.get(), world);
	}

	public NetherSpiderEntity(EntityType<NetherSpiderEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 6;
		setNoAi(false);
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new LeapAtTargetGoal(this, (float) 0.25));
	...
	public static void init() {
		SpawnPlacements.register(FightsfrightsModEntities.NETHER_SPIDER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
