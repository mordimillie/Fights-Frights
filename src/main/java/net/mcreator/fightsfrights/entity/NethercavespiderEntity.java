...
public class NethercavespiderEntity extends Spider {
	public NethercavespiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.NETHERCAVESPIDER.get(), world);
	}

	public NethercavespiderEntity(EntityType<NethercavespiderEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 6;
		setNoAi(false);
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new LeapAtTargetGoal(this, (float) 0.75));
	...
	public static void init() {
		SpawnPlacements.register(FightsfrightsModEntities.NETHERCAVESPIDER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
