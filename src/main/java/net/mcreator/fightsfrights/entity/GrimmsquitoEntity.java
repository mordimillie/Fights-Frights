...
public class GrimmsquitoEntity extends Monster implements GeoEntity {
	...
	public GrimmsquitoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.GRIMMSQUITO.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "grimmsquitodefault");
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:grimmsquito_death"));
	}
	...
	public static void init() {
		SpawnPlacements.register(FightsfrightsModEntities.GRIMMSQUITO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return GrimmsquitoNaturalEntitySpawningConditionProcedure.execute(world, x, y, z);
		});
		DungeonHooks.addDungeonMob(FightsfrightsModEntities.GRIMMSQUITO.get(), 180);
	}
