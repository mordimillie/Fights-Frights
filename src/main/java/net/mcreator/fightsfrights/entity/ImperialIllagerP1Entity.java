...
public class ImperialIllagerP1Entity extends Monster implements GeoEntity {
	...
	public ImperialIllagerP1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.IMPERIAL_ILLAGER_P_1.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "imperial_illager_phase1");
