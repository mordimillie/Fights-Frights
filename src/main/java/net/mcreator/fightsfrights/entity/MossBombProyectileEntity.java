...
public class MossBombProyectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public MossBombProyectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(FightsfrightsModEntities.MOSS_BOMB_PROYECTILE.get(), world);
	}
	...
	public MossBombProyectileEntity(EntityType<? extends MossBombProyectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public MossBombProyectileEntity(EntityType<? extends MossBombProyectileEntity> type, LivingEntity entity, Level world) {
	...
	public static MossBombProyectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		MossBombProyectileEntity entityarrow = new MossBombProyectileEntity(FightsfrightsModEntities.MOSS_BOMB_PROYECTILE.get(), entity, world);
	...
	public static MossBombProyectileEntity shoot(LivingEntity entity, LivingEntity target) {
		MossBombProyectileEntity entityarrow = new MossBombProyectileEntity(FightsfrightsModEntities.MOSS_BOMB_PROYECTILE.get(), entity, entity.level());
