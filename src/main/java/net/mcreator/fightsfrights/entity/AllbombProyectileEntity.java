...
public class AllbombProyectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public AllbombProyectileEntity(EntityType<? extends AllbombProyectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public AllbombProyectileEntity(EntityType<? extends AllbombProyectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(FightsfrightsModItems.ALLBOMB.get());
	}
	...
	public static AllbombProyectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		AllbombProyectileEntity entityarrow = new AllbombProyectileEntity(FightsfrightsModEntities.ALLBOMB_PROYECTILE.get(), entity, world, null);
	...
	public static AllbombProyectileEntity shoot(LivingEntity entity, LivingEntity target) {
		AllbombProyectileEntity entityarrow = new AllbombProyectileEntity(FightsfrightsModEntities.ALLBOMB_PROYECTILE.get(), entity, entity.level(), null);
