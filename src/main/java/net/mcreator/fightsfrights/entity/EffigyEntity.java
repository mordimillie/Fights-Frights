...
public class EffigyEntity extends IronGolem implements GeoEntity {
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:effigy_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:effigy_death"));
	}
