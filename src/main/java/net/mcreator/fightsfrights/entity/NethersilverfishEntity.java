...
public class NethersilverfishEntity extends Monster {
	public NethersilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.NETHERSILVERFISH.get(), world);
	}

	public NethersilverfishEntity(EntityType<NethersilverfishEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(FightsfrightsModEntities.NETHERSILVERFISH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
