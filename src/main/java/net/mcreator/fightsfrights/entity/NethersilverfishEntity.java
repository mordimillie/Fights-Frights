...
public class NethersilverfishEntity extends Monster {
	public NethersilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.HIVEMITE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(FightsfrightsModEntities.HIVEMITE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
