...
import net.mcreator.fightsfrights.procedures.PoppingProcedure;
...
public class ScowlEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new ScowlEntity.RangedAttackGoal(this, 1.25, 60, 10f) {
			@Override
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:scowl_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:scowl_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("fightsfrights:scowl_death"));
	}

	@Override
	public boolean hurt(DamageSource source, float amount) {
		PoppingProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), source, this);
	...
	public EntityDimensions getDefaultDimensions(Pose pose) {
		...
		return super.getDefaultDimensions(pose).scale((float) PoppedProcedure.execute(entity));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(FightsfrightsModEntities.SCOWL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
