...
public class InfectionPCraftBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> BrewingRecipeRegistry.addRecipe(new InfectionPCraftBrewingRecipe()));
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionUtils.setPotion(new ItemStack(input.getItem()), FightsfrightsModPotions.INFECTION_P.get());
		}
