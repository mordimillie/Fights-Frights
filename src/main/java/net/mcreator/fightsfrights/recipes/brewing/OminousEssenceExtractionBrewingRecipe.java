...
public class OminousEssenceExtractionBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> BrewingRecipeRegistry.addRecipe(new OminousEssenceExtractionBrewingRecipe()));
	}

	@Override
	public boolean isInput(ItemStack input) {
		return Ingredient.of(new ItemStack(FightsfrightsModItems.OMINOUS_BOTTLE.get())).test(input);
	}
