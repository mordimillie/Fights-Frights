...
public abstract class OminousArmorItem extends ArmorItem {
	public OminousArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(FightsfrightsModItems.OMINOUS_PLATE.get()));
			}

			@Override
			public String getName() {
				return "ominous_armor";
			}
	...
	public static class Helmet extends OminousArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fightsfrights:textures/models/armor/ominous_armor_layer_1.png";
		}
	...
	public static class Leggings extends OminousArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fightsfrights:textures/models/armor/ominous_armor_layer_2.png";
		}
