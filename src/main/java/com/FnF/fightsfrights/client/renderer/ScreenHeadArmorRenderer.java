...
import net.mcreator.fightsfrights.item.model.ScreenHeadModel;
import net.mcreator.fightsfrights.item.ScreenHeadItem;

public class ScreenHeadArmorRenderer extends GeoArmorRenderer<ScreenHeadItem> {
	public ScreenHeadArmorRenderer() {
		super(new ScreenHeadModel());
	...
	@Override
	public RenderType getRenderType(ScreenHeadItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
