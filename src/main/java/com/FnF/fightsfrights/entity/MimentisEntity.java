...
public class MimentisEntity extends Spider implements GeoEntity {
	...
	public MimentisEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.MIMENTIS.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mimentis");
		this.entityData.define(DATA_Health_reduction, 0);
		this.entityData.define(DATA_roam_timer, 0);
		this.entityData.define(DATA_is_roaming, false);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:mimentis_idle"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:mimentis_step")), 0.15f, 1);
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:mimentis_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fightsfrights:mimentis_death"));
	}
	...
	public static void init() {
		SpawnPlacements.register(FightsfrightsModEntities.MIMENTIS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return MimentisNaturalEntitySpawningConditionProcedure.execute(world, x, y, z);
		});
	}
