...
public class ShadowcompanioncompanionEntity extends Monster implements GeoEntity {
	...
	public ShadowcompanioncompanionEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FightsfrightsModEntities.SHADOWCOMPANIONCOMPANION.get(), world);
	}
	...
	public static void init() {
		DungeonHooks.addDungeonMob(FightsfrightsModEntities.SHADOWCOMPANIONCOMPANION.get(), 180);
	}
