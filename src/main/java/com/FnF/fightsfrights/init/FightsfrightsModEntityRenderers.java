...
import net.mcreator.fightsfrights.client.renderer.PioneerHeadRenderer;
...
import net.mcreator.fightsfrights.client.renderer.FireSwarmRenderer;
...
public class FightsfrightsModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(FightsfrightsModEntities.HIVEMITE.get(), NethersilverfishRenderer::new);
		...
		event.registerEntityRenderer(FightsfrightsModEntities.FIRE_SWARM.get(), FireSwarmRenderer::new);
		event.registerEntityRenderer(FightsfrightsModEntities.PIONEER_HEAD.get(), PioneerHeadRenderer::new);
	}
}
