...
public class FightsfrightsModGameRules {
	...
	public static final GameRules.Key<GameRules.IntegerValue> FIGHTSFRIGHTSMOBSPAWNCHANCE = GameRules.register("fightsfrightsmobspawnchance", GameRules.Category.SPAWNING, GameRules.IntegerValue.create(20));
}
